...
// Zeus: Thetis VAC helpers; Win32 CRITICAL_SECTION handles, never P/Invoked by Zeus.
PORT void
*NewCriticalSection()
{	// used by VAC
...
#if !defined(linux) && !defined(__APPLE__)
// Zeus: developer-only raw audio capture (Windows console tooling); gated
// exactly as in the 1.29 tree.
