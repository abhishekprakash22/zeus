...
// The MULTI-encoder badge used to be defined and mounted HERE — a mistake:
// this component is the Settings→Display card ABOUT the G2 layout, so the
// position:fixed chip only existed while that settings tab was open (the
// round-4 field report, verbatim). It now lives in G2MultiBadge.tsx and is
// mounted by App.tsx as always-on G2 chrome.
